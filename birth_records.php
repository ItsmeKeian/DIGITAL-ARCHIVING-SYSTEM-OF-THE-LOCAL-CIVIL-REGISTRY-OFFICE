<?php
/* ============================================
   LCR DIGITAL ARCHIVING SYSTEM - BIRTH RECORDS
...
<head>
    ...
    <style>
        ...
        /* ── Camera Modal ── */
        #cameraModal .modal { max-width: 520px; }
        #cameraFeed { width: 100%; border-radius: 8px; background: #000; display: block; }
        ...
        .view-value { font-size: 0.88rem; color: #2d2d2d; font-weight: 400; }
